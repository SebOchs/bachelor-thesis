...
# Preprocessor of mnli data set for albert
...
class AlbertPreprocessor:
    ...
    def __init__(self, tokenizer, data=None, data_path=None, save_path=None, mode='test', split=0.9, cls=['[CLS]'],
                 sep=['[SEP]'], pad=['[PAD]'],
                 max_len=128):
        """
        ...
        :param data: location of the data set
        """
...
if __name__ == '__main__':
    ...
    # Train Data
    AlbertPreprocessor(tokenizer, data_path='../data/datasets/training/mnli/multinli_1.0_train.jsonl',
                     save_path='../data/preprocessed/mnli_albert',
                     mode='train').preprocess()
    # Test Data
    AlbertPreprocessor(tokenizer, data_path='../data/datasets/testing/mnli/multinli_1.0_dev_matched.jsonl',
                     save_path='../data/preprocessed/mnli_matched_albert',
                     mode='test').preprocess()
    AlbertPreprocessor(tokenizer, data_path='../data/datasets/testing/mnli/multinli_1.0_dev_mismatched.jsonl',
                     save_path='../data/preprocessed/mnli_mismatched_albert',
                     mode='test').preprocess()
